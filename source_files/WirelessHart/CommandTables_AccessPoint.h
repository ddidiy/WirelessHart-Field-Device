...
#ifndef DEVICECOMMANDTABLES_ACCPOINT_H_
#define DEVICECOMMANDTABLES_ACCPOINT_H_
...
//#define INCLUDE_RECOMMENDED_COMMANDS
    ...
    #define INCLUDE_RECOMMENDED_COMPR_ACCPOINT_COMMANDS
...
//	CREATE_COMPOSER_RESP_PARSER_REQ_EXECUTE_ENTRY(C053_WriteDeviceVariableUnits),                       // Recommended - TBD
	CREATE_COMPOSER_RESP_PARSER_REQ_EXECUTE_ENTRY(C054_ReadDeviceVariableInformation),                  
...
#ifdef INCLUDE_RECOMMENDED_COMPR_ACCPOINT_COMMANDS
...
//	CREATE_NULLCOMPOSER_RESP_NULLPARSER_REQ_NULLEXECUTE_ENTRY(C799_RequestService),             // required on NM only
  ...
  CREATE_COMPOSER_RESP_PARSER_REQ_EXECUTE_ENTRY(C818_WriteChannelBlacklist),                          // used on Transceiver only
...
#endif /* DEVICECOMMANDTABLES_ACCPOINT_H_ */
