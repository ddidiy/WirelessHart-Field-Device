...
uint8_t Compose_C804_ReadRadioCCAMode_Req(C804_ReadRadioCCAMode_Req* request, 
		BinaryStream* toStream)
{
	return RCS_N00_Success;
}

uint8_t Parse_C804_ReadRadioCCAMode_Req(C804_ReadRadioCCAMode_Req* request, 
...
{
#if defined(_DEBUG)
  if (STREAM_GetRemainingSize(fromStream) > C804_RespSize)
    return RCS_E01_Undefined1; // too many bytes
#endif
