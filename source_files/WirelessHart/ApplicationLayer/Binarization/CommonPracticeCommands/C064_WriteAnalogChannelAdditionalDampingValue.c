...
uint8_t Compose_C064_WriteAnalogChannelAdditionalDampingValue_Req(
		C064_WriteAnalogChannelAdditionalDampingValue_Req* request,  BinaryStream* toStream)
{
...
uint8_t Parse_C064_WriteAnalogChannelAdditionalDampingValue_Req(
		C064_WriteAnalogChannelAdditionalDampingValue_Req* request, BinaryStream* fromStream)
{
...
uint8_t Compose_C064_WriteAnalogChannelAdditionalDampingValue_Resp(
		C064_WriteAnalogChannelAdditionalDampingValue_Resp* response,  BinaryStream* toStream)
{
...
uint8_t Parse_C064_WriteAnalogChannelAdditionalDampingValue_Resp(
		C064_WriteAnalogChannelAdditionalDampingValue_Resp* response, BinaryStream* fromStream)
{
