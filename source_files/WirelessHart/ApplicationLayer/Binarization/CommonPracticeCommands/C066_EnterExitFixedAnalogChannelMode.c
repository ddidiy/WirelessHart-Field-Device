...
#include "C066_EnterExitFixedAnalogChannelMode.h"

uint8_t Compose_C066_EnterExitFixedAnalogChannelMode_Req(C066_EnterExitFixedAnalogChannelMode_Req* request,
...
uint8_t Parse_C066_EnterExitFixedAnalogChannelMode_Req(C066_EnterExitFixedAnalogChannelMode_Req* request, BinaryStream* fromStream)
{
...
uint8_t Compose_C066_EnterExitFixedAnalogChannelMode_Resp(C066_EnterExitFixedAnalogChannelMode_Resp* response,
		 BinaryStream* toStream)
{
...
uint8_t Parse_C066_EnterExitFixedAnalogChannelMode_Resp(C066_EnterExitFixedAnalogChannelMode_Resp* response, BinaryStream* fromStream)
{
