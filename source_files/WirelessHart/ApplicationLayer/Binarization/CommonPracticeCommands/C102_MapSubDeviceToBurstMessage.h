...
#ifndef C102_MAPSUBDEVICETOBURSTMESSAGE_H_
#define C102_MAPSUBDEVICETOBURSTMESSAGE_H_
...
uint8_t Parse_C102_MapSubDeviceToBurstMessage_Req(C102_MapSubDeviceToBurstMessage_Req* request,
...
#endif /* C102_MAPSUBDEVICETOBURSTMESSAGE_H_ */
