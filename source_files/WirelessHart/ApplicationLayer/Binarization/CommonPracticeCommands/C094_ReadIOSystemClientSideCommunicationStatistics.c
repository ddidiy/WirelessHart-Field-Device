...
uint8_t Compose_C094_ReadIOSystemClientSideCommunicationStatistics_Req(
		C094_ReadIOSystemClientSideCommunicationStatistics_Req* request,  BinaryStream* toStream)
{
	return RCS_N00_Success;
}

uint8_t Parse_C094_ReadIOSystemClientSideCommunicationStatistics_Req(
		C094_ReadIOSystemClientSideCommunicationStatistics_Req* request,  BinaryStream* fromStream)
{
	return RCS_N00_Success;
}

uint8_t Compose_C094_ReadIOSystemClientSideCommunicationStatistics_Resp(
		C094_ReadIOSystemClientSideCommunicationStatistics_Resp* response,  BinaryStream* toStream)
{
...
uint8_t Parse_C094_ReadIOSystemClientSideCommunicationStatistics_Resp(
		C094_ReadIOSystemClientSideCommunicationStatistics_Resp* response,  BinaryStream* fromStream)
{
