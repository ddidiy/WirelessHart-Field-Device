...
#ifndef C073_FINDDEVICE_H_
#define C073_FINDDEVICE_H_
...
uint8_t Compose_C073_FindDevice_Req(C073_FindDevice_Req* request, 
		BinaryStream* toStream);

uint8_t Parse_C073_FindDevice_Req(C073_FindDevice_Req* request, BinaryStream* fromStream);

uint8_t Compose_C073_FindDevice_Resp(C073_FindDevice_Resp* response, 
		BinaryStream* toStream);
