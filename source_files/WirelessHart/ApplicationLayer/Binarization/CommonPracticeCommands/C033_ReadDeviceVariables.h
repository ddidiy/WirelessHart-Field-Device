...
#ifndef ReadDeviceVariables_H_
#define ReadDeviceVariables_H_
 ...
 * @param p_pBuffer
 */
uint8_t Compose_C033_ReadDeviceVariables_Req(C033_ReadDeviceVariables_Req* request, BinaryStream* toStream);
 ...
 *
 */
uint8_t Compose_C033_ReadDeviceVariables_Resp(C033_ReadDeviceVariables_Resp* response, BinaryStream* toStream);
