...
#include "C815_AddDeviceListTableEntry.h"

uint8_t Compose_C815_AddDeviceListTableEntry_Req ( C815_AddDeviceListTableEntry_Req* request,
...
uint8_t Parse_C815_AddDeviceListTableEntry_Req ( C815_AddDeviceListTableEntry_Req* request,
                                    BinaryStream* fromStream )
{
#if defined(_DEBUG)
  if (STREAM_GetRemainingSize(fromStream) > C815_ReqSize)
...
uint8_t Compose_C815_AddDeviceListTableEntry_Resp ( C815_AddDeviceListTableEntry_Resp* response,
                                    BinaryStream* toStream )
{
...
uint8_t Parse_C815_AddDeviceListTableEntry_Resp ( C815_AddDeviceListTableEntry_Resp* response,
                                    BinaryStream* fromStream )
{
#if defined(_DEBUG)
  if (STREAM_GetRemainingSize(fromStream) > C815_RespSize)
    return RCS_E01_Undefined1; // too many bytes
#endif
