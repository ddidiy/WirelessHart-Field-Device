...
#ifndef DEVICECOMMANDTABLES_FIELDDEV_H_
#define DEVICECOMMANDTABLES_FIELDDEV_H_

#include "../system.h"

//#define INCLUDE_RECOMMENDED_COMMANDS

#if( WIHARTDEV_TYPE == WIHARTDEV_TYPE_FIELDDEV ) 

  #ifdef INCLUDE_RECOMMENDED_COMMANDS
    #define INCLUDE_RECOMMENDED_COMPR_FIELDDEV_COMMANDS
    #define INCLUDE_RECOMMENDED_WIRELESS_COMMANDS
  #endif
  #ifdef USE_LOOP_CONTROL
    #define INCLUDE_MANDATORY_LOOP_FIELDDEV_COMMANDS
    #ifdef INCLUDE_RECOMMENDED_COMMANDS
      #define INCLUDE_RECOMMENDED_LOOP_FIELDDEV_COMMANDS
    #endif
  #endif
...
// device is acting as a Slave for the following commands
...
#if ( _UAP_TYPE != UAP_TYPE_WHART_API )   
	CREATE_COMPOSER_RESP_PARSER_REQ_EXECUTE_ENTRY(C033_ReadDeviceVariables),
#endif        
//	CREATE_COMPOSER_RESP_PARSER_REQ_NULLEXECUTE_ENTRY(C034_WritePrimaryVariableDampingValue),
#ifdef INCLUDE_MANDATORY_LOOP_FIELDDEV_COMMANDS
  #if ( _UAP_TYPE != UAP_TYPE_WHART_API ) 
	CREATE_COMPOSER_RESP_PARSER_REQ_NULLEXECUTE_ENTRY(C035_WritePrimaryVariableRangeValues),            // Mandatory if loop control - TBD 
  #endif      
#endif // INCLUDE_MANDATORY_LOOP_FIELDDEV_COMMANDS
...
//	CREATE_COMPOSER_RESP_PARSER_REQ_NULLEXECUTE_ENTRY(C037_SetPrimaryVariableLowerRangeValue),
  ...
  // Common Practice Commands
#ifdef INCLUDE_MANDATORY_LOOP_FIELDDEV_COMMANDS
	CREATE_COMPOSER_RESP_PARSER_REQ_NULLEXECUTE_ENTRY(C040_EnterExitFixedCurrentMode),                  // Mandatory if loop control - TBD
#endif // INCLUDE_MANDATORY_LOOP_FIELDDEV_COMMANDS
...
#ifdef INCLUDE_MANDATORY_LOOP_FIELDDEV_COMMANDS
  #if ( _UAP_TYPE != UAP_TYPE_WHART_API ) 
	CREATE_COMPOSER_RESP_PARSER_REQ_NULLEXECUTE_ENTRY(C045_TrimLoopCurrentZero),                        // Mandatory if loop control - TBD
	CREATE_COMPOSER_RESP_PARSER_REQ_NULLEXECUTE_ENTRY(C046_TrimLoopCurrentGain),                        // Mandatory if loop control - TBD
...
//	CREATE_COMPOSER_RESP_PARSER_REQ_NULLEXECUTE_ENTRY(C047_WritePrimaryVariableTransferFunction),
  ...
  #ifdef INCLUDE_RECOMMENDED_COMPR_FIELDDEV_COMMANDS
  ...
  #endif // INCLUDE_RECOMMENDED_COMPR_FIELDDEV_COMMANDS
...
//	CREATE_COMPOSER_RESP_PARSER_REQ_EXECUTE_ENTRY(C102_MapSubDeviceToBurstMessage),                     // Adapter Mandatory
  ...
  #endif //( _UAP_TYPE != UAP_TYPE_WHART_API )         
//	CREATE_COMPOSER_RESP_PARSER_REQ_NULLEXECUTE_ENTRY(C111_TransferServiceControl),                   // Mandatory - TBD
//	CREATE_COMPOSER_RESP_PARSER_REQ_NULLEXECUTE_ENTRY(C112_TransferService),                          // Mandatory - TBD
...
//CREATE_COMPOSER_RESP_PARSER_REQ_EXECUTE_ENTRY(C818_WriteChannelBlacklist),              
...
//	CREATE_COMPOSER_RESP_PARSER_REQ_EXECUTE_ENTRY(C845_WriteNetworkConstraints),
  ...
  CREATE_COMPOSER_RESP_PARSER_REQ_EXECUTE_ENTRY(C967_WriteLink),                                      // Mandatory
	...
	{0xffff, 0, 0, 0, 0} //nicu.dascalu - only for testing, to detect end of array
};


#endif /* DEVICECOMMANDTABLES_FIELDDEV_H_ */
